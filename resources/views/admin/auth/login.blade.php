...
<head>
    ...
    <body class="login-body">
        ...
        <div class="login-logo">
            <img src="{{asset('admin_asset/img/login-logo.png')}}" alt=""/>
        </div>
        
        <h2 class="form-heading">Admin login</h2>
        <div class="container log-row">
            {!!Form::open(['route'=>'admin.login.post','class'=>'form-signin'])!!}
                <div class="login-wrap">
                    {!!form::text('email','',['class'=>'form-control','placeholder'=>'Email id', 'autofocus'])!!}
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="forgotPass" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['route'=>'admin.forgetPassword.post','role'=>'form']) !!}
