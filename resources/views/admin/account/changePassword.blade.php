                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              ...
                              <li class="active"><a href="{{ route('admin.changepassword.form') }}"> <i class="fa fa-calendar"></i> Change Password </a></li>
                          </ul>
                  ...
                  <aside class="profile-info col-lg-9">
                     <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                            {!! Form::open(['route'=>'admin.changepassword.post','method'=>'put']) !!}
