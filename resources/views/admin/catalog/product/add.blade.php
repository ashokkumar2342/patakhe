            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add New Product Of The Month</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            {!! Form::open(['route'=>'admin.product.create.post','class'=>'validate cmxform','files'=>true]) !!}
                                    ...
                                    <div class="categoryTree" id="category">
                                        <ul>
                                            @foreach($categories as $category)
                                                <li id="{{ $category->id }}"><a>{{ $category->name }}</a></li>
                                            @endforeach 
                                       </ul>
                                    </div>
                                </div>
...
<script src="{{ asset('js/vakata-jstree/tree.js') }}"></script>
