    ...
    <br>
        <div id="saleForm" class="collapse row">
            <div class="panel panel-default col-md-12 ">
                ...
                {!! Form::open(['route'=>['seller.product.item.sale.post',$product->ukey,$productItem->ukey]]) !!}
                     {!! Form::hidden('referr', route('seller.product.item.view',[$product->ukey,$productItem->ukey]), []) !!}
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label for="selling_price">Selling Price <span class="text-danger">*</span></label>
                            {!! Form::number('selling_price', '', ['class'=>'form-control','placeholder'=>'Selling price','required']) !!}
