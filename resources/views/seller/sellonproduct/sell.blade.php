    ...
    <br>
        <div id="createColor" class="collapse {{ ($errors->first())?'in':'' }} row">
            <div class="panel panel-default col-md-8 col-md-offset-2 ">
                ...
                {!! Form::open(['route'=>['seller.sop.create.post',$product->ukey]]) !!}
                     <div class="form-group clearfix">
                        {!! Form::label('color', 'Color', ['class'=>'control-label','id'=>'e4']) !!}
                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="colorAvi">
                        {{-- {{{ App\Model\Catalog\ProductItemColors::where('iid',$productItem->id)->get() }}} --}}
                        {{-- <input type="text" name="oldColor" value="{{ implode(',') }}">   --}}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" placeholder="Selling price" name="msp" type="text" value="" id="msp">
                            <label class="text-danger">{{ $errors->first('msp') }}</label>
                        </div>
                        <div class="form-group col-md-6">
                            {!! Form::label('stock', 'Stock', ['class'=>'control-label']) !!}
                            {!! Form::number('stock', '', ['placeholder'=>"Item in stock",'class'=>'form-control']) !!}
